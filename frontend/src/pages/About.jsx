      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-warm-lg p-8 md:p-12 mb-12 fade-in border border-primary-100">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-dark-700 mb-6">Our Mission</h2>
              <p className="text-dark-600 text-lg leading-relaxed mb-4">
                We are dedicated to rescuing animals from abandonment, abuse, and neglect. Our mission is to provide them with medical care, rehabilitation, and find them loving forever homes.
              </p>
              <p className="text-dark-600 text-lg leading-relaxed">
                Every animal deserves a second chance, and we work tirelessly to make that happen through community support, education, and direct action.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-warm hover:shadow-warm-lg transition-all duration-300 text-center transform hover:-translate-y-2 fade-in border border-primary-50" style={{ animationDelay: '0.3s' }}>
            ...
            <h3 className="text-xl font-bold text-dark-700 mb-2">Impact</h3>
            <p className="text-dark-500">Making a real difference in animals' lives</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 text-white rounded-2xl shadow-warm-lg p-8 md:p-12 fade-in relative overflow-hidden">
          ...
          <h2 className="text-4xl font-bold text-center mb-12 relative z-10">Our Impact</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative z-10">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-6xl font-bold mb-2">500+</div>
              <div className="text-xl text-secondary-100">Animals Rescued</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-6xl font-bold mb-2">350+</div>
              <div className="text-xl text-secondary-100">Adopted</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-6xl font-bold mb-2">50+</div>
              <div className="text-xl text-secondary-100">Volunteers</div>
            </div>
          </div>
        </div>
      </div>
